 ...
 * under the License.
 */
import { SupersetPluginChartHospitalOccupancy } from '../src';
 ...
 */
describe('superset-plugin-chart-hospital-occupancy', () => {
  it('exists', () => {
    expect(SupersetPluginChartHospitalOccupancy).toBeDefined();
  });
});
